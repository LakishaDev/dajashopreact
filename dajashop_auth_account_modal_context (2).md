      ...
      {authOpen && (
        ...
        >
          ...
          >
            ...
            {/* Tabs sa animiranom indikacijom */}
            <div className="tabs">
              <button
              ...
              >
                Prijava
                {isLogin && <motion.span layoutId="tabActive" className="tab-active" />}
              </button>
              <button
                className={`tab ${!isLogin ? "active" : ""}`}
            ...
            {/* Switcher sa slide/fade animacijom izmedju formi */}
...
## 8) Stilovi po komponentama

### `src/components/AuthModal.css`
```css
/* ===== AuthModal (glass + forme + modal overlay) ===== */
.auth-overlay {
...
.glass {
  background: linear-gradient(
    180deg,
    color-mix(in oklab, var(--color-surface, #f5f5f7) 70%, transparent),
    color-mix(in oklab, var(--color-surface, #f5f5f7) 88%, transparent)
  );
  border: 1px solid color-mix(in oklab, var(--color-accent, #d2d2d7) 45%, transparent);
...
.tab { position: relative; padding: 8px 12px; border-radius: 999px; border: 1px solid transparent; background: transparent; color: var(--color-text, #111); }
.tab.active { border-color: color-mix(in oklab, var(--color-accent, #d2d2d7) 60%, transparent); background: var(--color-surface, #f5f5f7); }
.tab-active { position: absolute; left: 8px; right: 8px; bottom: 0; height: 2px; border-radius: 999px; background: var(--color-text, #111); }

/* Switcher da sakrije slajd pri animaciji */
.form-switcher { position: relative; overflow: hidden; }

.form { display: grid; gap: 12px; }
.field > span { display: block; font-size: 12px; color: var(--color-muted, #6e6e73); margin-bottom: 6px; }
.input { display: grid; grid-auto-flow: column; grid-auto-columns: max-content 1fr max-content; align-items: center; gap: 8px; padding: 10px 12px; border-radius: 12px; background: color-mix(in oklab, var(--color-surface, #f5f5f7) 96%, transparent); border: 1px solid color-mix(in oklab, var(--color-accent, #d2d2d7) 55%, transparent); }
.input .ico { opacity: .8; }
.input input { border: 0; outline: 0; background: transparent; color: var(--color-text, #111); font-size: 14px; width: 100%; }

.hint { font-size: 13px; color: var(--color-muted, #6e6e73); text-align: center; margin-top: 6px; }
.hint .link { border: 0; background: transparent; color: var(--color-text, #111); text-decoration: underline; cursor: pointer; }
...
.tabs { display: grid; grid-auto-flow: column; gap: 8px; margin-bottom: 14px; }
.tab { padding: 8px 12px; border-radius: 999px; border: 1px solid transparent; background: transparent; color: var(--color-text, #111); }
.tab.active { border-color: color-mix(in oklab, var(--color-accent, #d2d2d7) 60%, transparent); background: var(--color-surface, #f5f5f7); }
...
```css
/* ===== Account stranica (glass kartice) ===== */
.account-page { padding: 24px 0; }
.account-card, .account-empty { padding: 18px; }

/* Glass (isti vizuelni jezik kao u modalu) */
.glass {
  background: linear-gradient(
    180deg,
    color-mix(in oklab, var(--color-surface, #f5f5f7) 70%, transparent),
...
.avatar { width: 40px; height: 40px; border-radius: 999px; display: grid; place-items: center; background: var(--color-surface, #f5f5f7); border: 1px solid color-mix(in oklab, var(--color-accent, #d2d2d7) 55%, transparent); color: var(--color-text, #111); font-weight: 700; }
.avatar.small { width: 32px; height: 32px; }
.header-user { display: flex; align-items: center; gap: 8px; }
.muted { color: var(--color-muted, #6e6e73); }
...
### `src/components/HeaderLoginButton.css`
```css
/* ===== Header dugme / avatar ===== */
.header-user { display: flex; align-items: center; gap: 8px; }
.avatar.small { width: 32px; height: 32px; border-radius: 999px; display: grid; place-items: center; background: var(--color-surface, #f5f5f7); border: 1px solid color-mix(in oklab, var(--color-accent, #d2d2d7) 55%, transparent); color: var(--color-text, #111); font-weight: 700; }
```
